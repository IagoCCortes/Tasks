...
import {GRAY_DARK, SUCCESS, GRAY_MEDIUM_2, GRAY_LIGHT_3, BLACK} from 'styles/colors';
import {TextInput} from 'react-native-gesture-handler';
import useAnimatedHeader from 'hooks/useAnimatedHeader';
import {scaleSize} from 'styles/mixins';

const FormTextField2 = ({errors, handleChange, handleBlur, touched, values, name, fieldName}) => {
